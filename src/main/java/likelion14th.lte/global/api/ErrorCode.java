...
public enum ErrorCode implements BaseCode { // 실패
    ...
    TODO_ROUTINE_TYPE_CHANGE_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "TODO_4009", "루틴 타입은 변경할 수 없습니다."),
    TODO_DATE_NOT_FOUND(HttpStatus.NOT_FOUND, "TODO_4042", "해당 날짜의 투두 기록을 찾을 수 없습니다."),
    STAT_WEEK_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "STAT_5001", "요일별 통계 데이터가 초기화되지 않았습니다.")
    ;
